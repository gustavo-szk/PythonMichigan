...
# read the HTML from the data files below, and parse the data, extracting numbers and compute 
...
# Actual data: http://py4e-data.dr-chuck.net/comments_1247831.html (Sum ends with 45)
...
html=request.urlopen('http://py4e-data.dr-chuck.net/comments_1247831.html').read()
li=list()
count=0
